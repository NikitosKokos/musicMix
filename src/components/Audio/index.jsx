...
const Audio = ({ title, img, audio }) => {
    ...
    const formattingTime = (currentTime) => {
        const minutes = Math.floor(Math.round(currentTime) / 60);
        ...
        <div className='audio'>
            <div className="audio__content">
                ...
                <div className='audio__buttons'>
                    <button className=' audio__btn audio__btn_prev'>
                    ...
                    <button className='audio__btn audio__btn_next'>
                        <svg viewBox="0 0 300 200">
