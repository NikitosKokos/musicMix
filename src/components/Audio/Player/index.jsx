        ...
        <div className="player">
            <div className="player__content">
                <div className="player__favorites">
                    <button
                        className={`player__btn player__btn_heart ${favorite ? 'active' : ''}`}
                        onClick={onFavoriteChange}>
                        <svg viewBox="0 0 358 323" fill="none">
                            <path
                                d="M71 4C128.2 -12.4 167.167 31.5 179.5 55.5C179.5 43.5 233 -18 293 7C341 27 355 66.6667 356 84C366.4 116.8 328 175.667 307.5 201C250.7 269 198.167 310.333 179 322.5C131.8 291.3 76.6667 232.833 55 207.5C12.2 161.1 0.833331 112.833 0.499997 94.5C0.166663 71.1667 13.8 20.4 71 4Z"
                                fill="#bbb"
                            />
                            <path
                                d="M287.247 4C230.047 -12.4 191.081 31.5 178.747 55.5C178.747 43.5 125.247 -18 65.2474 7C17.2474 27 3.24744 66.6667 2.24744 84C-8.15256 116.8 30.2474 175.667 50.7474 201C107.547 269 160.081 310.333 179.247 322.5C226.447 291.3 281.581 232.833 303.247 207.5C346.047 161.1 357.414 112.833 357.747 94.5C358.081 71.1667 344.447 20.4 287.247 4Z"
                                fill="#bbb"
                            />
                        </svg>
                    </button>
                </div>
                <div className={`player__img ${!isInitializedImg ? 'player__img_loading' : ''}`}>
                    <img
                        ref={imgRef}
                        onLoad={onLoadImg}
                        src={img ? img : defaultSongImage}
                        alt="song"
                    />
                </div>
                ...
                <div className="player__buttons">
                    {songs.length > 1 && (
                        <button
                            className=" player__btn player__btn_arrow"
                            onClick={() => onChangeAudio('prev')}>
                            <svg viewBox="0 0 300 200">
                                <path
                                    d="M30.9937 84.8594L121.244 28.75C123.959 27.0676 127.076 26.1461 130.269 26.082C133.463 26.0179 136.614 26.8137 139.395 28.3859C142.175 29.9581 144.481 32.249 146.072 35.0185C147.663 37.7881 148.48 40.9344 148.438 44.1281V155.872C148.438 160.596 146.561 165.127 143.22 168.467C139.88 171.808 135.349 173.684 130.625 173.684C127.333 173.756 124.086 172.913 121.244 171.25L30.9937 115.378C28.4161 113.781 26.289 111.552 24.8139 108.902C23.3388 106.252 22.5645 103.27 22.5645 100.237C22.5645 97.205 23.3388 94.2226 24.8139 91.573C26.289 88.9235 28.4161 86.6943 30.9937 85.0969V84.8594Z"
                                    fill="#0B032D"
                                />
                                <path
                                    d="M132.625 84.0625L227.625 25C230.483 23.229 233.764 22.259 237.126 22.1916C240.487 22.1242 243.805 22.9618 246.731 24.6167C249.658 26.2717 252.086 28.6831 253.76 31.5984C255.435 34.5137 256.295 37.8257 256.25 41.1875V158.812C256.25 163.785 254.275 168.554 250.758 172.071C247.242 175.587 242.473 177.562 237.5 177.562C234.035 177.637 230.617 176.75 227.625 175L132.625 116.187C129.912 114.506 127.673 112.159 126.12 109.37C124.567 106.581 123.752 103.442 123.752 100.25C123.752 97.0579 124.567 93.9186 126.12 91.1295C127.673 88.3405 129.912 85.994 132.625 84.3125V84.0625Z"
                                    fill="#0B032D"
                                />
                            </svg>
                        </button>
